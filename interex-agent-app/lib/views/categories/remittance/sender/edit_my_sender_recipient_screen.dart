...
import '../../../../controller/categories/remittance/sender/edit_my_sender_recipient_controller.dart';
...
class EditMySenderRecipientScreen extends StatelessWidget {
  EditMySenderRecipientScreen({super.key});
      ...
      child: PrimaryButton(
          ...
          onPressed: () {
            if (formKey.currentState!.validate()) {
              controller.recipientUpdateApiProcess().then(
                (value) {
