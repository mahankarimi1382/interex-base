...
import '../../../../controller/categories/remittance/sender/add_my_sender_recipient_controller.dart';
...
class AddMySenderRecipientScreen extends StatelessWidget {
  AddMySenderRecipientScreen({super.key});

  final controller = Get.put(AddMySenderRecipientController());
  final mySenderRecipientController = Get.put(MySenderRecipientController());
  ...
  Row _nameEmailInput(BuildContext context) {
    return Row(
      children: [
        Expanded(
  ...
  Column _addressInput(BuildContext context) {
    return Column(
    ...
    return Column(
      ...
      children: [
        ...
        ReceiverCountryDropDown(
          ...
          onChanged: (value) {
            controller.receiverCountrySelectedMethod.value =
  ...
  Column _accountNumberWidget(BuildContext context) {
    return Column(
      children: [
        PrimaryInputWidget(
