...
class PaymentsEditScreenMobile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBarWidget(text: Strings.paymentLinkEdit.tr),
        body: Obx(
  ...
  Obx _customerChooseWidget(BuildContext context) {
    return Obx(() {
      return Visibility(
  ...
  Padding _typeSelectionDropdownWidget(BuildContext context) {
    return Padding(
      ...
      child: CustomDropDown<TypeSelectionModel>(
        ...
        titleTextColor: CustomColor.primaryLightTextColor.withValues(
          alpha: .15,
        ),
        ...
        dropDownIconColor: CustomColor.primaryLightTextColor.withValues(
          alpha: 0.30,
        ),
      ),
    );
  ...
  Obx _optionalImageUploadWidget(BuildContext context) {
    return Obx(
      () => UploadImageWidget(
  ...
  PrimaryInputField _titleWidget(BuildContext context) {
  ...
  CustomDropDown<CurrencyDatum> _currencyDropdownWidget(BuildContext context) {
  ...
  Container _setLimitCheckBoxWidget(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          Obx(
            () => SizedBox(
              ...
              child: Checkbox(
                ...
                checkColor: controller.setLimit.value
          ...
          TitleHeading5Widget(
            ...
            color: CustomColor.primaryLightTextColor.withValues(alpha: .6),
          ),
        ],
      ),
    );
  ...
  Obx _amountLimitInputWidget(BuildContext context) {
    return Obx(
      () => Visibility(
            ...
            children: [
              Expanded(
                child: PrimaryInputField(
                  ...
                  suffixIcon: _customCurrencyWidget(
  ...
  Obx _productsAndSubscriptionsWidget(BuildContext context) {
    return Obx(
      () => Visibility(
        visible:
  ...
  PrimaryInputField _productsAndSubscriptionsTitleWidget(BuildContext context) {
    return PrimaryInputField(
      fillColor: CustomColor.whiteColor,
  ...
  Padding _productsAndSubscriptionsPriceWidget(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(
        top: Dimensions.paddingVerticalSize * 0.5,
        bottom: Dimensions.paddingVerticalSize * 0.5,
  ...
  Padding _createNewLinkButtonWidget(BuildContext context) {
    return Padding(
