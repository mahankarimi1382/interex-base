...
class SettingScreen extends StatelessWidget {
      ...
      children: [
        Row(
          children: [
            ...
            const Expanded(flex: 2, child: ChangeLanguageWidget()),
          ],
        ),
        Divider(
          thickness: Dimensions.radius * .1,
          color: CustomColor.whiteColor.withValues(alpha: .10),
        ),
      ],
    );
  }

  Column _changePasswordText(BuildContext context) {
    return Column(
  ...
  Column _inSetUpText(BuildContext context) {
    return Column(
      crossAxisAlignment: crossStart,
      children: [
        Container(
