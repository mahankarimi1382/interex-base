...
class MoneyInLogScreen extends StatelessWidget {
  const MoneyInLogScreen({super.key, required this.controller});
  final TransactionController controller;

  @override
  Widget build(BuildContext context) {
    var data = controller.transactioData.data.transactions.moneyIn;
    return SizedBox(
  ...
  GestureDetector _mainListWidget(int i, List<MoneyIn> data, BuildContext context) {
