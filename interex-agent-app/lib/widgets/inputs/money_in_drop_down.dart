...
import 'package:qrpay/controller/categories/money_in/money_in_controller.dart';
...
class MoneyInInputWithDropdown extends StatefulWidget {
  ...
  const MoneyInInputWithDropdown({
    super.key,
  ...
  @override
  State<MoneyInInputWithDropdown> createState() => _PrimaryInputWidgetState();
}

class _PrimaryInputWidgetState extends State<MoneyInInputWithDropdown> {
  FocusNode? focusNode;
  final currencyController = Get.put(MoneyInController());
