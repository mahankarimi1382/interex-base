          ...
          items: controller.currencyList.map<DropdownMenuItem<String>>((value) {
            return DropdownMenuItem<String>(
              onTap: () {
                ...
                controller.gatewayRate.value = double.parse(value.rate);
                controller.exchangeRate.value = double.parse(value.rate) /
                    double.parse(
      ...
      return Container(
        ...
        child: DropdownButton<MainUserWallet>(
          ...
          onChanged: (MainUserWallet? value) {
            ...
            controller.selectCurrency.value = value.currency.code;
            ...
            if (value.currency.type == "CRYPTO") {
              ...
              controller.isCryptoCurrency.value = false;
            }
        ...
        child: Column(
          children: [
            LimitWithExchangeRateWidget(
              ...
              limit:
                  "${controller.limitMin.value.toStringAsFixed(limitPrecision)} ~ ${controller.limitMax.value.toStringAsFixed(limitPrecision)} ${controller.selectMainWallet.value!.currency.code}",
            ),
            Row(
