...
AddMoneyBkashInsertModel addMoneyBikashInsertModelFromJson(String str) =>
    AddMoneyBkashInsertModel.fromJson(json.decode(str));

String addMoneyBikashInsertModelToJson(AddMoneyBkashInsertModel data) =>
...
class AddMoneyBkashInsertModel {
  ...
  AddMoneyBkashInsertModel({required this.message, required this.data});

  factory AddMoneyBkashInsertModel.fromJson(Map<String, dynamic> json) =>
