...
MySenderEditModel mySenderEditModelFromJson(String str) =>
    MySenderEditModel.fromJson(json.decode(str));

String mySenderEditModelToJson(MySenderEditModel data) =>
    json.encode(data.toJson());

class MySenderEditModel {
  final Message message;
  final Data data;

  MySenderEditModel({required this.message, required this.data});

  factory MySenderEditModel.fromJson(Map<String, dynamic> json) =>
      MySenderEditModel(
