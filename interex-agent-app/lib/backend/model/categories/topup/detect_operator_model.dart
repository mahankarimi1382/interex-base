class DetectOperatorModel {
  ...
  DetectOperatorModel({required this.data});

  factory DetectOperatorModel.fromJson(Map<String, dynamic> json) =>
      DetectOperatorModel(data: DetectOperatorModelData.fromJson(json["data"]));
}
...
class Fx {
  ...
  factory Fx.fromJson(Map<String, dynamic> json) =>
      Fx(rate: json["rate"]?.toDouble(), currencyCode: json["currencyCode"]);
...
class Fees {
  ...
  factory Fees.fromJson(Map<String, dynamic> json) => Fees(
    ...
    internationalPercentage: json["internationalPercentage"]?.toDouble() ?? 0.0,
  );
}
