...
class Data {
  ...
  Data({required this.token, required this.agent});

  factory Data.fromJson(Map<String, dynamic> json) =>
      Data(token: json["token"], agent: Agent.fromJson(json["agent"]));

  Map<String, dynamic> toJson() => {"token": token, "agent": agent.toJson()};
}
