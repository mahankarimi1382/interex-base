...
class Routes {
  ...
  static const String bkashtoWebPaymnetScreen = '/bkashWebPaymentScreen';
  ...
  static const String sendMoneyQRCodeScreen = '/sendMoneyQRCodeScreen';
  ...
  // Money In
  static const String moneyInPreviewScreen = '/moneyInPreviewScreen';
  static const String moneyInScreen = '/moneyInScreen';

  /// Sender Recipient
  static const String mySenderRecipientScreen = '/mySenderRecipientScreen';
  static const String editMySenderRecipientScreen =
      '/editMySenderRecipientScreen';
  static const String addMySenderRecipientScreen =
      '/addMySenderRecipientScreen';

  //money exchange
  static const String moneyExchange = '/moneyExchange';
  static const String exchangeMoneyPreviewScreen =
