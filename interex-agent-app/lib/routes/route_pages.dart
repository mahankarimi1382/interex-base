...
import '../views/categories/add_money/bkash_web_payment_screen.dart';
...
class RoutePageList {
  static var list = [
    ...
    GetPage(name: Routes.walletScreen, page: () => WalletsScreen()),
    GetPage(
    ...
    GetPage(name: Routes.moneyInScreen, page: () => MoneyInScreen()),
    ...
    GetPage(
      name: Routes.bkashtoWebPaymnetScreen,
