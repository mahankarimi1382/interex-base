...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['totalAddMoney'] = amountOnBaseCurrency(Transaction::agentAuth()->addMoney()->where('status', 1)->get());
        $data['totalWithdrawMoney'] = amountOnBaseCurrency(Transaction::agentAuth()->moneyOut()->where('status', 1)->get());
        $data['totalSendMoney'] = amountOnBaseCurrency(Transaction::agentAuth()->senMoney()->where('status', 1)->get());
        $data['totalMoneyIn'] = amountOnBaseCurrency(Transaction::agentAuth()->moneyIn()->where('status', 1)->get());
        $data['totalReceiveMoney'] = amountOnBaseCurrency(Transaction::agentAuth()->agentMoneyOut()->where('status', 1)->get());
        $data['totalSendRemittance'] = amountOnBaseCurrency(Transaction::agentAuth()->remitance()->where('attribute', 'SEND')->get());
        ...
        $data['agent_profits'] = agentOnBaseCurrency(AgentProfit::agentAuth()->get());
        ...
        return view('agent.dashboard', compact('page_title', 'baseCurrency', 'transactions', 'data', 'chartData', 'fiat_wallets', 'crypto_wallets'));
    }
