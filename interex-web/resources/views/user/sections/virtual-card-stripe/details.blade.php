                        ...
                        <div class="preview-list-item">
                            ...
                            <div class="preview-list-right">
                                <div class="toggle-containers">
                                    <input type="checkbox" id="toggle-switch" onchange="handleToggleChange(this)"
                                        style="display: none">
                                    <label for="toggle-switch" class="card-eye-btn"
                                        style="cursor: pointer;margin-bottom:0"><i class="las la-eye"></i></label>
                                </div>
                            </div>
                        </div>
                    </div>
