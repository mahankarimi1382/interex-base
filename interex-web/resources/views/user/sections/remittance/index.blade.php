                                ...
                                <div class="col-xl-6 col-lg-6 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <span class="input-group-text sender_curr_code">{{ get_default_currency_code() }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 form-group">
...
<script>
   ...
   $(document).ready(function(){
    ...
    function acceptVar() {
        ...
        var receiver_country         = $("select[name=to_country] :selected").val();
        var receiver_country_name    = $("select[name=to_country] :selected").data('name');
    ...
    function checkReciverCountry(){
        ...
        var to_country   = acceptVar().receiver_country;
    ...
    function recipientFilterByCountry(){
        var receiver_country = acceptVar().receiver_country;
    ...
    function getPreview() {
        ...
        var receiver_country_name = acceptVar().receiver_country_name;
        ...
        $('.receiver-county').text(receiver_country_name);
