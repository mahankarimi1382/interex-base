...
<section class="account">
    <div class="account-area">
        <div class="account-wrapper">
            ...
            <form class="account-form" action="{{ setRoute('user.email.verify.code',$token) }}" method="POST">
                @csrf
    ...
    function resetTime (second = 60) {
        ...
        var x = setInterval(function () {  // Get today's date and time
            ...
            if (distance < 0 || second < 2 ) {
                ...
                document.querySelector(".time-area").innerHTML = "Didn't get the code? <a href='{{ setRoute('user.email.resend.code') }}' onclick='resendOtp()' class='text--danger'>Resend</a>";
            }
