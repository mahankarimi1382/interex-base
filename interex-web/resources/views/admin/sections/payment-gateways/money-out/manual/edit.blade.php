...
@section('breadcrumb')
    ...
    ], 'active' => __("Withdraw Gateway Edit")])
@endsection

@section('content')
<form action="{{ setRoute('admin.payment.gateway.update',['withdraw','manual',$payment_gateway->alias]) }}" method="POST" enctype="multipart/form-data">
