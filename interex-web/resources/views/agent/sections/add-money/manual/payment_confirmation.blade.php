...
@php
   ...
   $wallet_precision    =  $hasData->data->amount->wallet_precision;
@endphp
@push('css')
                        ...
                        <div class="preview-list-wrapper">
                            <div class="preview-list-item">
                                ...
                                <div class="preview-list-right">
                                    <span class="request-amount">{{ get_amount(@$hasData->data->amount->requested_amount,$hasData->data->amount->receiver_cur_code,$wallet_precision)}}</span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                <div class="preview-list-left">
                            ...
                            <div class="preview-list-item">
                                ...
                                <div class="preview-list-right">
                                    <span class="fees">{{ get_amount(@$hasData->data->amount->total_charge,$hasData->data->amount->sender_cur_code,$pricison)}}</span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                <div class="preview-list-left">
                                ...
                                <div class="preview-list-right">
                                    <span class="will-get">{{ get_amount(@$hasData->data->amount->will_get,$hasData->data->amount->receiver_cur_code,$wallet_precision)}}</span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                <div class="preview-list-left">
                                ...
                                <div class="preview-list-right">
                                    <span class="text--warning last pay-in-total">{{ get_amount(@$hasData->data->amount->total_amount,$hasData->data->amount->sender_cur_code,$pricison)}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
