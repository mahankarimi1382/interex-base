...
class ApiEndpoint {
  // static const String mainDomain = ""; http://10.0.2.2:8000
  ...
  static String verifyForgotOTPEmailURL = '/user/forget/verify/otp'
      .addBaseURl();
  static String verifyEmailURL = '/user/email-verify'.addBaseURl();
  static String checkingUserURL = '/user/forget/password/check/user'
      .addBaseURl();
  static String resetPasswordURL = '/user/forget/reset/password'.addBaseURl();

  // phone verification
  static String verifyRegisterPhoneOTPURL = '/user/register/sms/verify/otp'
      .addBaseURl();
  static String resendRegisterPhoneOTPURL = '/user/register/sms/resend/otp'
      .addBaseURl();
  ...
  static String sendRegisterEmailOTPURL = '/user/register/send/otp'
      .addBaseURl();
  static String verifyRegisterEmailOTPURL = '/user/register/email/verify/otp'
      .addBaseURl();

  // Forgot password using phone otp
  static String resendForgotPhoneOTPURL = '/user/forget/sms/resend'
      .addBaseURl();
  static String verifyForgotPhoneOTPURL = '/user/forget/sms/verify/otp'
      .addBaseURl();
  //! navbar
  ...
  static String cardTransactionURL = '/user/my-card/transaction?card_id='
      .addDBaseURl();
  ...
  static String checkUserWithQeCodeURL = '/user/send-money/qr/scan'
      .addBaseURl();
  ...
  static String cardyfieTransactionCard =
      '/user/cardyfie-card/transaction?card_id='.addDBaseURl();
  ...
  static String manualWithdrawConfirmURL = '/user/withdraw/manual/confirmed'
      .addBaseURl();
  ...
  static String topUpAutomaticConfirmedURL = '/user/mobile-topup/automatic/pay'
      .addBaseURl();
  static String automaticPayURL = '/user/mobile-topup/automatic/pay'
      .addBaseURl();
  ...
  static String recipientDynamicFieldURL = '/user/recipient/dynamic/fields'
      .addBaseURl();

  static String recipientCheckUserURL = '/user/recipient/check/user'
      .addBaseURl();
  ...
  static String remittanceGetRecipientURL = '/user/remittance/get/recipient'
      .addBaseURl();
  static String remittanceConfirmedURL = '/user/remittance/confirmed'
      .addBaseURl();
  ...
  static String checkMerchantExistURL = '/user/make-payment/check/merchant'
      .addBaseURl();
  static String checkMerchantWithQeCodeURL = '/user/make-payment/merchants/scan'
      .addBaseURl();
  ...
  static String makeRemoveDefaultURl =
      '/user/my-card/stripe/make-remove/default'.addBaseURl();

  //-> payments
  static String paymentLinkGetURL = '/user/payment-links'.addBaseURl();
  static String paymentLinkEditGetURL = '/user/payment-links/edit?target='
      .addDBaseURl();
  static String paymentLinkStoreURL = '/user/payment-links/store'.addBaseURl();
  static String paymentLinkUpdateURL = '/user/payment-links/update'
      .addBaseURl();
  ...
  static String requestMoneySubmitURL = '/user/request-money/submit'
      .addBaseURl();
  static String requestMoneyQrScanURL = '/user/request-money/qr/scan'
      .addBaseURl();
  static String requestMoneyCheckUserURL = '/user/request-money/check/user'
      .addBaseURl();
  static String requestMoneyLogsRejectURL = '/user/request-money/logs/reject'
      .addBaseURl();
  static String requestMoneyLogsApproveURL = '/user/request-money/logs/approve'
      .addBaseURl();
  ...
  /// Strowallet
  static String strowalletCardURL = '/user/strowallet-card'.addDBaseURl();
  ...
  static String strowalletCardMakeOrRemoveDefaultFundURL =
      '/user/strowallet-card/make-remove/default'.addDBaseURl();
  ...
  static String qrCodeScanAgentMoneyOutURL = '/user/money-out/qr/scan'
      .addBaseURl();
  ...
  static String moneyExchangeSubmitURL = '/user/money-exchange/submit'
      .addBaseURl();
  ...
  // remaining balance
  static String remainingBalanceURL = '/user/get-remaining?transaction_type='
      .addDBaseURl();
  ...
  // My Chat
  static String userListURL = '/user/p2p/chat'.addBaseURl();
  static String userSearchURL = '/user/p2p/chat/user/check'.addBaseURl();
  static String createChatURL = '/user/p2p/chat/create'.addBaseURl();
  static String conversationURL = '/user/p2p/chat/conversation'.addBaseURl();
  static String sendMessageURL = '/user/p2p/chat/message/send'.addBaseURl();

  // Trade
  static String tradeListURL = '/user/trade'.addBaseURl();
  static String tradeSubmitURL = '/user/trade/submit'.addBaseURl();
  static String tradeCloseURL = '/user/trade/close'.addBaseURl();
  static String tradeEditURL = '/user/trade/edit'.addBaseURl();
  static String tradeUpdateURL = '/user/trade/update'.addBaseURl();

  // Get Offer
  static String makeAnOfferURL = '/user/offer/submit'.addBaseURl();
  static String counterOfferURL = '/user/offer/submit'.addBaseURl();
  ...
  // Marketplace
  static String marketplaceListURL = '/user/marketplace'.addDBaseURl();
  ...
  static String marketplaceBuyConfirmURL = '/user/marketplace/confirm'
      .addBaseURl();
