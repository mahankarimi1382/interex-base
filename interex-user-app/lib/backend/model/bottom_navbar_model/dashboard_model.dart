  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    transactions: List<Transaction?>.from(
      json["transactions"].map(
        (x) => x == null ? null : Transaction.fromJson(x),
      ),
    ),
...
class ModuleAccess {
  ...
  factory ModuleAccess.fromJson(Map<String, dynamic> json) => ModuleAccess(
    ...
    moneyOut: json["money_out"] ?? true,
    giftCards: json["gift_cards"] ?? true,
    moneyExchange: json["money_exchange"] ?? true,
    trade: json["trade"] ?? true,
    myChat: json["my_chat"] ?? true,
  );
...
class UserWallet {
  ...
  UserWallet({required this.status, required this.currency});
