class StripeCardDetailsModel {
  ...
  StripeCardDetailsModel({required this.message, required this.data});
...
class Data {
  ...
  Data({required this.baseCurr, required this.cardDetails});
...
class StatusInfo {
  ...
  StatusInfo({required this.active, required this.inactive});

  factory StatusInfo.fromJson(Map<String, dynamic> json) =>
      StatusInfo(active: json["active"], inactive: json["inactive"]);

  Map<String, dynamic> toJson() => {"active": active, "inactive": inactive};
}
