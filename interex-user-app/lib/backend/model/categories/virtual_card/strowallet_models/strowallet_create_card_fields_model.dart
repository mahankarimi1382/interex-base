...
class StrowalletCardCreateInfo {
  ...
  StrowalletCardCreateInfo({required this.message, required this.data});
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    customerKycStatusCanBe: List<String>.from(
      json["customer_kyc_status_can_be"].map((x) => x),
    ),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "customer_create_fields": List<dynamic>.from(
      customerCreateFields.map((x) => x.toJson()),
    ),
    "customer_exist": customerExist.toJson(),
    "customer_kyc_status_can_be": List<dynamic>.from(
      customerKycStatusCanBe.map((x) => x),
    ),
    "customer_kyc_status": customerKycStatus,
    "customer_low_kyc_text": customerLowKycText,
    "card_create_fields": List<dynamic>.from(
      cardCreateFields.map((x) => x.toJson()),
    ),
  };
}
