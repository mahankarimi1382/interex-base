...
class GiftCardListModel {
  ...
  GiftCardListModel({required this.message, required this.data});
...
class Data {
  ...
  Data({required this.products, required this.countries});
...
class Products {
  ...
  Products({required this.data, required this.lastPage});
...
class Brand {
  ...
  factory Brand.fromJson(Map<String, dynamic> json) =>
      Brand(brandId: json["brandId"], brandName: json["brandName"]);

  Map<String, dynamic> toJson() => {"brandId": brandId, "brandName": brandName};
}
