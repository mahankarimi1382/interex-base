      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: Get.isDarkMode ? CustomColor.whiteColor.withValues(alpha: .05): CustomColor.primaryBGLightColor,
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              height: 16.0,
                                              color: Get.isDarkMode ? Colors.white.withValues(alpha: .05 ): Colors.white,
                                            ),
                                          ],
                                        ),
                                      )
