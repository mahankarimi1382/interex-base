...
import 'package:qrpaypro/controller/categories/deposit/deposti_controller.dart';
...
class ManualPaymentImageWidget extends StatelessWidget {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(width: 1, color: CustomColor.primaryLightColor),
        ),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.file_upload, color: CustomColor.primaryLightColor),
  ...
  Container imagePickerBottomSheetWidget(BuildContext context) {
    return Container(
