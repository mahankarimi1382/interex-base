...
import 'transactions/marketplace_log_screen.dart';
...
import 'transactions/trade_log_screen.dart';
...
class TransactionLogScreen extends StatelessWidget {
  ...
  TabBar get _tabBarWidget => TabBar(
    ...
    tabs: [
      ...
      Tab(
        child: _textWidget(Strings.moneyExchange, textAlign: TextAlign.center),
      ),
      ...
      Tab(
        child: _textWidget(Strings.virtualCardLog, textAlign: TextAlign.center),
      ),
      Tab(
      ...
      Tab(
        child: _textWidget(Strings.makePaymentLog, textAlign: TextAlign.center),
      ),
      Tab(
        child: _textWidget(Strings.agentMoneyOut, textAlign: TextAlign.center),
      ),
      Tab(child: _textWidget(Strings.payLink, textAlign: TextAlign.center)),
      Tab(
        child: _textWidget(Strings.payUserPayLink, textAlign: TextAlign.center),
      ),
      Tab(
        child: _textWidget(
      ...
      Tab(child: _textWidget(Strings.trade, textAlign: TextAlign.center)),
      Tab(child: _textWidget(Strings.marketplace, textAlign: TextAlign.center)),
    ],
  );
    ...
    return Container(
      ...
      child: TabBarView(
        ...
        children: [
          ...
          TradeLogScreen(controller: controller),
          MarketplaceLogScreen(controller: controller),
        ],
      ),
    );
  }
