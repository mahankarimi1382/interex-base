...
class MarketplaceLogScreen extends StatelessWidget {
  const MarketplaceLogScreen({super.key, required this.controller});
  final TransactionController controller;

  @override
  Widget build(BuildContext context) {
    var data = controller.transactioData.data.transactions.marketplace;
    return SizedBox(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    data[i].method.isEmpty
                        ? SizedBox.shrink()
                        : ExpendedItemWidget(
                            title: Strings.paymentMethod.tr,
                            value: data[i].method,
                          ),
                    data[i].seller.isEmpty
                        ? SizedBox.shrink()
                        : ExpendedItemWidget(
