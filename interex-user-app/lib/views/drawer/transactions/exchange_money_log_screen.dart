...
class ExchangeMoneyLogScreen extends StatelessWidget {
  const ExchangeMoneyLogScreen({super.key, required this.controller});
  final TransactionController controller;

  @override
  Widget build(BuildContext context) {
    var data = controller.transactioData.data.transactions.exchangeMoney;
    return SizedBox(
  ...
  GestureDetector _mainListWidget(int i, List<ExchangeMoney> data, BuildContext context) {
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      ExpendedItemWidget(
                        title: Strings.exchangeableAmount,
                        value: data[i].exchangeableAmount,
                      ),
                      ExpendedItemWidget(
