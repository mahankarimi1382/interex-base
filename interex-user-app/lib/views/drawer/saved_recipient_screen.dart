...
import 'package:qrpaypro/widgets/drawer/save_recipients_widget.dart';
  ...
  Widget build(BuildContext context) {
    return ResponsiveLayout(
      mobileScaffold: Scaffold(
        ...
        appBar: const AppBarWidget(text: Strings.savedReceipients),
        body: Obx(
                ...
                onTap: (value) {
                  ...
                  if (value == "Remove Recipient") {
                    controller
                        ...
                        .then(
                          (value) => Get.offAllNamed(Routes.bottomNavBarScreen),
                        );
