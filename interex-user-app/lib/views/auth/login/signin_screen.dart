...
import 'package:qrpaypro/widgets/others/glass_widget.dart';
...
class _SignInScreenState extends State<SignInScreen> {
  ...
  Container _logoWidget(BuildContext context, {required double logoHeight}) {
    return Container(
      ...
      padding: EdgeInsets.only(
        ...
        left: Dimensions.marginSizeVertical * 1.6,
        right: Dimensions.marginSizeVertical * 1.6,
      ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          TitleHeading4Widget(text: Strings.signInInformationSubtitle.tr),
        ],
      ),
    );
  }
  ...
  Future _openDialogue(BuildContext context) {
    return showDialog(
      context: context,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AuthDropdown<String>(
                        ...
                        selectMethod: controller.selectedLogInType,
                        onChanged: (v) {
                          controller.selectedLogInID.value = v == 'Email'
                              ? 0
                              : 1;
                        },
                      ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (controller.selectedLogInType.value ==
                                ...
                                //   initialSelection: 'US',
                                //   onChanged: (value) {
                                //     controller.selectedPhoneCode.value = value
                                //         .toString();
                                //   },
      ...
      ).customGlassWidget(blurY: 1, blurX: 1),
    );
  }
            ...
            children: [
              ...
              CustomCountryDropDown<Country>(
                ...
                flag: basicDataController
                    ...
                    .iso2
                    .toLowerCase(),
                items: basicDataController.basicDataModel.data.countries,
                onChanged: (v) {
                  controller.selectedPhoneCode.value = v!.mobileCode;
                },
              ),
