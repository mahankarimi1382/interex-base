    ...
    return ResponsiveLayout(
      mobileScaffold: Scaffold(
        ...
        body: LiquidSwipe(
          ...
          pages: appSettingsController.onboardScreen.map((data) {
            return Container(
              color: Colors.white,
              child: Stack(
                children: [
                  Positioned(
                    ...
                    child: CachedNetworkImage(
                      ...
                      imageUrl:
                          "${appSettingsController.baseUrl.value}/${appSettingsController.appSettingsModel.data.screenImagePath}/${data.image}",
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          border: Border.all(color: CustomColor.transparent),
                        ),
...
Obx _titleAndSubTitleWidget(BuildContext context, data, controller) {
  return Obx(
    () => Container(
      margin: EdgeInsets.symmetric(
...
InkWell _skipButtonWidget(BuildContext context) {
  return InkWell(
    onTap: (() {
