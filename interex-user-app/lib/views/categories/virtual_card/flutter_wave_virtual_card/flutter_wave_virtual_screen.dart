...
class FlutterWaveVirtualCardScreen extends StatelessWidget {
  ...
  Obx _cardWidget(BuildContext context) {
  ...
  Container cardFontWidget(BuildContext context, MyCard data) {
    return Container(
  ...
  Container cardBackWidget(BuildContext context, MyCard data) {
    return Container(
