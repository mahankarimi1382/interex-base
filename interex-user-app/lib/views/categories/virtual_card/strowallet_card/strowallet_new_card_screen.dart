...
class CrateStrowalletScreen extends StatelessWidget {
  ...
  Visibility _customerCreate(BuildContext context) {
    return Visibility(
  ...
  Container _customerCreateButtonWidget(BuildContext context) {
    return Container(
  ...
  Container _customerUpdate(BuildContext context) {
    var data = controller.strowalletCardCreateInfo.data;
    return Container(
  ...
  StrowalletFlipCardWidget _imageWidget(BuildContext context) {
  ...
  Container _amountFields(BuildContext context) {
    return Container(
  ...
  Column _chargeWidget(BuildContext context) {
