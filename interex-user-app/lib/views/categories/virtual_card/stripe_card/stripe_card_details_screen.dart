...
class StripeCardDetailsScreen extends StatelessWidget {
  ...
  Container _cardDetailsWidget(BuildContext context) {
    var myCards = controller.cardDetailsModel.data.cardDetails;

    return Container(
      margin: EdgeInsets.only(top: Dimensions.heightSize * 0.4),
      decoration: BoxDecoration(
          color: Get.isDarkMode ? CustomColor.whiteColor.withValues(alpha: .1) : CustomColor.primaryLightColor.withValues(alpha: .1),
                        ...
                        : InkWell(
                            ...
                            child: Icon(
                              controller.isShowSensitive.value == false
                                  ...
                                  : Icons.visibility,
                              color: Get.isDarkMode ? CustomColor.whiteColor.withValues(alpha: .6) : CustomColor.primaryLightTextColor
