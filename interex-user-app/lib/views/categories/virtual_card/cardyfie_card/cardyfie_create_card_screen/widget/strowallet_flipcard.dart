    ...
    return FlipCard(
      ...
      front: Container(
        ...
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
              image: NetworkImage(
                  controller.cardyfieCardModel.data.cardBasicInfo.cardBg),
                ...
                Container(
                    ...
                    child: Column(
                      children: [
                        Image.network(
                          controller
                              .cardyfieCardModel.data.cardBasicInfo.siteLogo,
            ...
            Row(
              children: [
                ...
                Padding(
                  ...
                  child: Image.asset(
                    Assets.clipart.contactLess.path,
                    height: Dimensions.heightSize * 2,
                    width: Dimensions.widthSize * 3,
                  ),
                ),
      ...
      back: Container(
        ...
        decoration: BoxDecoration(
          ...
          // image: DecorationImage(
          //   image: AssetImage(Assets.clipart.backPart.path),
          //   fit: BoxFit.cover,
          // ),
        ),
        child: Column(
