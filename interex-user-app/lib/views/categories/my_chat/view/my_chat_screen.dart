  ...
  Widget build(BuildContext context) {
    return ResponsiveLayout(
      mobileScaffold: Scaffold(
          ...
          body: Obx(() => (controller.isLoading || controller.isCreateLoading)
              ? const CustomLoadingAPI()
              : _bodyWidget(context)),

          floatingActionButton: !showAppBar ? null: Obx(() => Visibility(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          CircleAvatar(
                            radius: 30,
                            backgroundImage: NetworkImage(user.senderImage.image),
                          ),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                TitleHeading4Widget(text: user.senderImage.email),
                              ],
                            ),
                          ),
                          horizontalSpace(Dimensions.paddingHorizontalSize * .3),
                          Column(
                            ...
                            children: [
                              TitleHeading5Widget(
                                  text:
                                      DateFormat('hh:mm a').format(user.updatedAt)),
                              TitleHeading5Widget(
