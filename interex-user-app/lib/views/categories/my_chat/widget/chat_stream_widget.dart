                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.only(
                                topLeft: Radius.circular(isOwnMessage ? Dimensions.radius * 1.6 : 0),
                                topRight: Radius.circular(Dimensions.radius * 1.6),
                                bottomLeft: Radius.circular(Dimensions.radius * 1.6),
                                bottomRight: Radius.circular(!isOwnMessage ? Dimensions.radius * 1.6 : 0),
                              ),
                            ),
                            child: Row(
                              mainAxisSize: mainMin,
                              mainAxisAlignment:
                                  isOwnMessage ? mainEnd : mainStart,
                              children: [
                                isOwnMessage
                                    ? SizedBox.shrink()
                                    : CircleAvatar(
                                        ...
                                        backgroundImage:
                                            NetworkImage(message.profileImg),
                                      ),
                                horizontalSpace(5),
                                Expanded(
                                  flex: message.message.length.isGreaterThan(20) ? 1 : 0,
                                  child: Text(
                                    message.message,
                                    style: TextStyle(
                                      color: isOwnMessage
