...
mixin MyChatApiServices {
  ...
  Future<UserListModel?> getUserListProcessApi(String page) async {
    ...
    try {
      mapResponse = await ApiMethod(isBasic: false).get(
        "${ApiEndpoint.userListURL}&page=$page",
        code: 200,
      );
      if (mapResponse != null) {
      ...
      log.e(
          '🐞🐞🐞 err from  Get User List api service ==> $e 🐞🐞🐞');
  ...
  async {
    ...
    try {
      ...
      if (mapResponse != null) {
        ...
        UserSearchModel.fromJson(mapResponse);
        CustomSnackBar.success(result.message.success.first.toString());
        return result;
      }
    } catch (e) {
      log.e(
          'err from post User Check Api service ==> $e');
  ...
  async {
    ...
    try {
      ...
      if (mapResponse != null) {
        CreateChatModel result =
        CreateChatModel.fromJson(mapResponse);
        CustomSnackBar.success(result.message.success.first.toString());
        return result;
      }
    } catch (e) {
      log.e(
          'err from post Create Chat Process API service ==> $e');
  ...
  async {
    ...
    try {
      ...
      if (mapResponse != null) {
        ...
        ConversationModel.fromJson(mapResponse);
        // CustomSnackBar.success(result.message.success.first.toString());
        return result;
      }
    } catch (e) {
      log.e(
          'err from post Conversation Process API service ==> $e');
  ...
  async {
    ...
    try {
      ...
      log.e(
          'err from post Send Message Process API service ==> $e');
