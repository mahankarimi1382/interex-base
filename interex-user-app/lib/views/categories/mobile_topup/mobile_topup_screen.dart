...
import 'package:qrpaypro/utils/custom_switch_loading_api.dart';
...
class MobileTopUpScreen extends StatelessWidget {
  ...
  Column _selectedTopUpType(BuildContext context) {
    return Column(
      crossAxisAlignment: crossStart,
      children: [
        CustomTitleHeadingWidget(
        ...
        children: [
          ...
          if (controller.isDetectLoading) ...[
            Padding(
              ...
              child: CustomSwitchLoading(color: CustomColor.primaryDarkColor),
            ),
          ],
