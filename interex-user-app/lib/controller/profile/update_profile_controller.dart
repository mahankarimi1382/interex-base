...
import '../../views/categories/virtual_card/cardyfie_card/model/country_model.dart';
...
class UpdateProfileController extends GetxController {
  ...
  String getIso2ByMobileCode(String mobileCode) {
    ...
    final normalizedInput = (mobileCode).replaceAll('+', '');

    final match = countryList.firstWhere(
      (item) {
        final code = (item["mobile_code"] ?? '').toString().replaceAll('+', '');
