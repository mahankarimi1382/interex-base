...
import 'package:qrpaypro/backend/model/add_money/add_money_razorpay_insert_model.dart';

import '../../../backend/model/add_money/add_money_authorize_insert_model.dart';
import '../../../backend/model/add_money/add_money_bkash_payment_model.dart';
...
class DepositController extends GetxController {
  ...
  // --------------------------- Api function ----------------------------------
  // add money stripe
  Future<AddMoneyAuthorizeInsertModel> addMoneyAuthorizeInsertProcess() async {
    _isInsertLoading.value = true;
    update();
  ...
  final RxString expiredDate = "".obs;
  final RxString cvc = "".obs;
  final RxBool showBack = false.obs;

  ///* AddMoneyManualSubmit in process
  Future<CommonSuccessModel> authorizedSubmitProcess() async {
    _isAuthorizedSubmitLoading.value = true;
    update();
    Map<String, String> inputBody = {
      "identifier": addMoneyAuthorizeInsertModel.data.paymentInformation.trx,
  ...
  Future<AddMoneyBkashInsertModel> addMoneyBikashInsertProcess() async {
    _isInsertLoading.value = true;
    update();
  ...
  void goToWebFlutterWavePaymentViewScreen() {
  ...
  void goToPerfectMoneyScreen() {
    Get.toNamed(Routes.perfectMoneyWebPaymentScreen);
  }

  void goToBkashScreen() {
    Get.toNamed(Routes.perfectMoneyWebPaymentScreen);
  }

  void gotoPaystackScreen() {
  ...
  void goToRazorPayScreen() {
    Get.toNamed(Routes.razorPayScreen);
  }

  void goToPagaditoWebPaymentScreen() {
    Get.toNamed(Routes.pagaditoWebPaymentScreen);
  }

  void goToManualSendMoneyManualScreen() {
  ...
  void gotoAuthorizeUSDScreen() {
    Get.toNamed(Routes.addMoneyAuthorizedPaymentScreen);
  }
