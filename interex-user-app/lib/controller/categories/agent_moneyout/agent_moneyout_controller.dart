...
import 'package:qrpaypro/backend/model/categories/agent-moneyout/agent_money_info_model.dart';
...
class AgentMoneyOutController extends GetxController {
  ...
  // ------------------------------API Function---------------------------------
  //
  Future<CommonSuccessModel> moneyOutProcess(BuildContext context) async {
