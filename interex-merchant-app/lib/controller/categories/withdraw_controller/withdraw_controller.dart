...
class WithdrawController extends GetxController {
  ...
  Future<WithdrawInfoModel> getWithdrawInfoData() async {
    ...
    await ApiServices.withdrawInfoAPi().then((value) {
      ...
      dailyLimit.value = double.parse(_moneyOutPaymentGatewayModel
          .data.gateways.first.currencies.first.dailyLimit);

      monthlyLimit.value = double.parse(_moneyOutPaymentGatewayModel
          .data.gateways.first.currencies.first.monthlyLimit);
