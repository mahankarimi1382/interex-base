...
class PaymentsEditScreenMobile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        await Get.offAllNamed(Routes.paymentLogScreen);
        return false;
      },
      child: Scaffold(
  ...
  PrimaryInputWidget _titleWidget(BuildContext context) {
  ...
  PrimaryInputWidget _productsAndSubscriptionsTitleWidget(
