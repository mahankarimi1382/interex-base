...
class TransactionLogModel {
  ...
  TransactionLogModel({required this.message, required this.data});
...
class Transactions {
  ...
  Map<String, dynamic> toJson() => {
    ...
    "merchant_payment": List<dynamic>.from(
      merchantPayment.map((x) => x.toJson()),
    ),
    "make_payment": List<dynamic>.from(makePayment.map((x) => x.toJson())),
    "add_sub_balance": List<dynamic>.from(addSubBalance.map((x) => x.toJson())),
...
class PaymentTypeGatewayData {
  ...
  Map<String, dynamic> toJson() => {"payment_gateway": paymentGateway};
}
...
class PaymentTypeWalletData {
  ...
  Map<String, dynamic> toJson() => {"sender_email": senderEmail};
}
