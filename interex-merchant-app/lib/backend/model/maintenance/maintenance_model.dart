...
MaintenanceModel maintenanceModelFromJson(String str) => MaintenanceModel.fromJson(json.decode(str));

String maintenanceModelToJson(MaintenanceModel data) => json.encode(data.toJson());
